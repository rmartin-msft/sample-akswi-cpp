...
// See https://github.com/Azure/azure-workload-identity/blob/main/examples/msal-net/akvdotnet/TokenCredential.cs
...
public class MyClientAssertionCredential : TokenCredential
{
    ...
    {
        Console.WriteLine(requestContext.TenantId);
        foreach(var s in requestContext.Scopes)
        {
